        ...
        try {
            ...
            while ($admin = $admin_result->fetch_assoc()) {
                ...
                $message = "🛒 New Order #{$order_number} from " . htmlspecialchars($user['full_name']) . 
                          " - Amount: " . format_currency($grandTotal) . 
            ...
            if (defined('ADMIN_EMAIL') && ADMIN_EMAIL) {
                ...
                $message .= "Total Amount: " . format_currency($grandTotal) . "\n";
                ...
                <div class="order-summary">
                    ...
                    <div class="summary-card">
                        ...
                        <div class="summary-row">
                            ...
                            <strong class="total-amount"><?php echo format_currency($grandTotal); ?></strong>
                        </div>
                        <div class="summary-row">
                    ...
                    <div class="receipt-body">
                        ...
                        <table class="receipt-items" style="width: 100%; border-collapse: collapse; margin: 15px 0;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right; padding: 8px; border-bottom: 1px solid #eee;"><?php echo format_currency($item['final_price']); ?></td>
                                    <td style="text-align: right; padding: 8px; border-bottom: 1px solid #eee;"><?php echo format_currency($item['subtotal']); ?></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                        ...
                        <div class="receipt-totals" style="margin: 15px 0;">
                            ...
                            <div class="total-row grand-total" style="display: flex; justify-content: space-between; margin: 10px 0; padding-top: 10px; border-top: 2px solid #000; font-weight: bold; font-size: 14px;">
                                <span>TOTAL AMOUNT:</span>
                                <span><?php echo format_currency($grandTotal); ?></span>
                            </div>
                        </div>
                ...
                <div class="checkout-form">
                    ...
                    <form method="POST" id="checkoutForm" class="payment-form">
                        ...
                        <div class="payment-details" id="bankTransferDetails" style="display: none;">
                            ...
                            <div class="bank-info">
                                <p><strong>Bank Name:</strong>NMB Bank</p>
                                <p><strong>Account Name:</strong> <?php echo SITE_NAME; ?> Inc.</p>
                                <p><strong>Account Number:</strong>21510016216</p>
                ...
                <div class="order-summary">
                        ...
                        <div class="order-item">
                            ...
                            <div class="item-info">
                                ...
                                <div class="item-meta">
                                    ...
                                    <span class="price"><?php echo format_currency($item['final_price']); ?> each</span>
                                </div>
                            </div>
                    ...
                    <div class="order-totals">
                        ...
                        <div class="total-row grand-total">
                            <span>Total Amount</span>
                            <span class="total-amount"><?php echo format_currency($grandTotal); ?></span>
                        </div>
                    </div>
